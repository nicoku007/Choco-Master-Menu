...
namespace definitive_edition
{
    public partial class Form1 : Form
    {
        ...
        private string tempWadPath = Path.Combine(Path.GetTempPath(), "D_RUNNIN.WAD");
        private string tempWadPath2 = Path.Combine(Path.GetTempPath(), "D_SHAWN2.WAD");
        private string tempWadPath3 = Path.Combine(Path.GetTempPath(), "D_DDTBL2.WAD");
        private string tempWadPath4 = Path.Combine(Path.GetTempPath(), "D_STALKS.WAD");
        private string tempWadPath5 = Path.Combine(Path.GetTempPath(), "D_COUNTD.WAD");
        private string tempWadPath6 = Path.Combine(Path.GetTempPath(), "D_BETWEE.WAD");
        private string tempWadPath7 = Path.Combine(Path.GetTempPath(), "D_DOOM.WAD");
        private string tempWadPath8 = Path.Combine(Path.GetTempPath(), "D_THE_DA.WAD");
        private string tempWadPath9 = Path.Combine(Path.GetTempPath(), "D_STLKS3.WAD");
        private string tempWadPath10 = Path.Combine(Path.GetTempPath(), "D_SHAWN.WAD");
        private string tempWadPath11 = Path.Combine(Path.GetTempPath(), "D_RUNNI2.WAD");
        private string tempWadPath12 = Path.Combine(Path.GetTempPath(), "D_DOOM2.WAD");
        private string tempWadPath13 = Path.Combine(Path.GetTempPath(), "D_DEAD2.WAD");
        private string tempWadPath14 = Path.Combine(Path.GetTempPath(), "D_DDTBLU.WAD");
        private string tempWadPath15 = Path.Combine(Path.GetTempPath(), "D_IN_CIT.WAD");
        private string tempWadPath16 = Path.Combine(Path.GetTempPath(), "D_DEAD.WAD");
        private string tempWadPath17 = Path.Combine(Path.GetTempPath(), "D_MESSAG.WAD");
        private string tempWadPath18 = Path.Combine(Path.GetTempPath(), "D_STLKS2.WAD");
        private string tempWadPath19 = Path.Combine(Path.GetTempPath(), "D_ROMERO.WAD");
        private string tempWadPath20 = Path.Combine(Path.GetTempPath(), "D_THEDA2.WAD");
        private string tempWadPath21 = Path.Combine(Path.GetTempPath(), "D_COUNT2.WAD");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_RUNNIN.WAD";



                string tempWadPath = Path.Combine(Path.GetTempPath(), "D_RUNNIN.WAD");
                string serverName2 = textBox23.Text;
                string argumentos4 = $" {serverName2}";
                string ipServidor4 = textBox25.Text;
                string argumentos5 = $" {ipServidor4}";
                string ipServidor6 = textBox26.Text;
                string argumentos6 = $" {ipServidor6}";
                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/ATTACK.WAD -warp 01M";
                string parametros = ConstruirParametros();
                string parametros27 = ConstruirParametros27();
                string parametros47 = ConstruirParametros47();
                string parametros48 = ConstruirParametros48();
                ...
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                ...
                using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(wadResourceName))
                {
                    ...
                    {
                        MessageBox.Show("The WAD resource could not be found.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
                }
                ...
                startInfo.Arguments = $" -file \"{tempWadPath}\" {master} {parametros} {Argument} {argumentos6} {parametros27} {argumentos6} {parametros48} {argumentos5} {parametros47}";
                ...
                {
                    MessageBox.Show($"Error starting Chocolate Doom: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2}  {param3} {param4} {param5}";
                EjecutarExe1(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                ;
                {
        ...
        private string ConstruirParametros()
        {
            ...
            {
                parametros += "chocolate-doom -merge master-wads/ATTACK.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/ATTACK.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/ATTACK.WAD -respawn -warp 01M ";
            }

            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/ATTACK.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/ATTACK.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/ATTACK.WAD -warp 01M -connect";
            }
        ...
        private void EjecutarExe1(string parametros)
        {
            ...
            {
                MessageBox.Show("Error: The system cannot find the specified file.");
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_SHAWN2.WAD";
                ...
                string ipServidor6 = textBox26.Text;
                string argumentos6 = $" {ipServidor6}";
                string demoName = textBox27.Text;
                string argumentos8 = $" {demoName}";
                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/BLACKTWR.WAD -warp 25M";
            ...
            else
            {
                ...
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe2(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros2()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLACKTWR.WAD -fast -warp 025M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLACKTWR.WAD -nomonsters -warp 025M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLACKTWR.WAD -respawn -warp 025M";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLACKTWR.WAD -warp 25M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLACKTWR.WAD -warp 25M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLACKTWR.WAD -warp 25M -connect ";
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_DDTBL2.WAD";



                string tempWadPath = Path.Combine(Path.GetTempPath(), "D_DDTBL2.WAD");
                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/BLOODSEA.WAD -warp 07M";
                string serverName2 = textBox23.Text;
                string argumentos4 = $" {serverName2}";
                string ipServidor4 = textBox25.Text;
                string argumentos5 = $" {ipServidor4}";
            ...
            else
            {
                ...
                string param5 = comboBox20.SelectedItem?.ToString() ?? "";
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe3(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros3()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLOODSEA.WAD -fast -warp 07M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLOODSEA.WAD -nomonsters -warp 07M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLOODSEA.WAD -respawn -warp 07M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLOODSEA.WAD -warp 07M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLOODSEA.WAD -warp 07M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/BLOODSEA.WAD -warp 07M -connect ";
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_STALKS.WAD";
                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/CANYON.WAD -warp 01M";
                string serverName2 = textBox23.Text;
                string argumentos4 = $" {serverName2}";
                string ipServidor4 = textBox25.Text;
                string argumentos5 = $" {ipServidor4}";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe4(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros4()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CANYON.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CANYON.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CANYON.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CANYON.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CANYON.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CANYON.WAD -warp 01M -connect ";
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/CATWALK.WAD -warp 01M";
                string wadResourceName = "definitive_edition.D_COUNTD.WAD";
                string serverName2 = textBox23.Text;
                string argumentos4 = $" {serverName2}";
                string ipServidor4 = textBox25.Text;
                string argumentos5 = $" {ipServidor4}";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe5(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros5()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CATWALK.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CATWALK.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CATWALK.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CATWALK.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CATWALK.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/CATWALK.WAD -warp 01M -connect ";
            }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_BETWEE.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/COMBINE.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe6(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros6()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/COMBINE.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/COMBINE.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/COMBINE.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/COMBINE.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/COMBINE.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/COMBINE.WAD -warp 01M -connect ";
            }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_DOOM.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/FISTULA.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe7(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros7()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/FISTULA.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/FISTULA.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/FISTULA.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/FISTULA.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/FISTULA.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/FISTULA.WAD -warp 01M -connect ";
            }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_THE_DA.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/GARRISON.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe8(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros8()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GARRISON.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GARRISON.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GARRISON.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GARRISON.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GARRISON.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GARRISON.WAD -warp 01M -connect ";
            }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_STLKS3.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/GERYON.WAD -warp 08M";
                ...
                {
                    MessageBox.Show($"Error starting Chocolate Doomm: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe9(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros9()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GERYON.WAD -fast -warp 08M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GERYON.WAD -nomonsters -warp 08M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GERYON.WAD -respawn -warp 08M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GERYON.WAD -warp 08M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GERYON.WAD -warp 08M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/GERYON.WAD -warp 08M -connect ";
            }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_SHAWN.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/MANOR.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe10(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros10()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MANOR.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MANOR.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MANOR.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MANOR.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MANOR.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MANOR.WAD -warp 01M -connect ";
            }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_RUNNI2.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/MEPHISTO.WAD -warp 07M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe11(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros11()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MEPHISTO.WAD -fast -warp 07M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MEPHISTO.WAD -nomonsters -warp 07M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MEPHISTO.WAD -respawn -warp 07M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MEPHISTO.WAD -warp 07M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MEPHISTO.WAD -warp 07M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MEPHISTO.WAD -warp 07M -connect ";
            }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_DOOM2.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/MINOS.WAD -warp 05M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe12(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros12()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MINOS.WAD -fast -warp 05M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MINOS.WAD -nomonsters -warp 05M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MINOS.WAD -respawn -warp 05M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MINOS.WAD -warp 05M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MINOS.WAD -warp 05M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/MINOS.WAD -warp 05M -connect ";
            }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_DEAD2.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/NESSUS.WAD -warp 07M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe13(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros13()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/NESSUS.WAD -fast -warp 07M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/NESSUS.WAD -nomonsters -warp 07M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/NESSUS.WAD -respawn -warp 07M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/NESSUS.WAD -warp 07M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/NESSUS.WAD -warp 07M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/NESSUS.WAD -warp 07M -connect ";
            }
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_DDTBLU.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/PARADOX.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe14(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros14()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/PARADOX.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/PARADOX.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/PARADOX.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/PARADOX.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/PARADOX.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/PARADOX.WAD -warp 01M -connect ";
            }
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_IN_CIT.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/SUBSPACE.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe15(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros15()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBSPACE.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBSPACE.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBSPACE.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBSPACE.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBSPACE.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBSPACE.WAD -warp 01M -connect ";
            }
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_DEAD.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/SUBTERRA.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe16(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros16()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBTERRA.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBTERRA.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBTERRA.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBTERRA.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBTERRA.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/SUBTERRA.WAD -warp 01M -connect ";
            }
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_MESSAG.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/TEETH.WAD -warp 31M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe17(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros17()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -fast -warp 31M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -nomonsters -warp 31M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -respawn -warp 31M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -warp 31M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -warp 31M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -warp 31M -connect ";
            }
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_STLKS2.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/TTRAP.WAD -warp 01M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe18(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros18()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TTRAP.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TTRAP.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TTRAP.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TTRAP.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TTRAP.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TTRAP.WAD -warp 01M -connect ";
            }
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_ROMERO.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/VESPERAS.WAD -warp 09M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe19(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros19()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VESPERAS.WAD -fast -warp 09M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VESPERAS.WAD -nomonsters -warp 09M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VESPERAS.WAD -respawn -warp 09M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VESPERAS.WAD -warp 09M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VESPERAS.WAD -warp 09M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VESPERAS.WAD -warp 09M -connect ";
            }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_THEDA2.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/VIRGIL.WAD -warp 03M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe20(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros20()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VIRGIL.WAD -fast -warp 03M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VIRGIL.WAD -nomonsters -warp 03M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VIRGIL.WAD -respawn -warp 03M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VIRGIL.WAD -warp 03M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VIRGIL.WAD -warp 03M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/VIRGIL.WAD -warp 03M -connect ";
            }
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string wadResourceName = "definitive_edition.D_COUNT2.WAD";


                string master = "chocolate-doom -iwad DOOM2.WAD -merge master-wads/TEETH.WAD -warp 32M";
            ...
            else
            {
                ...
                string parametros48 = ConstruirParametros48();
                string Argument = $"{param1} {param2} {param3} {param4} {param5}";
                EjecutarExe21(master + parametros + Argument + argumentos6 + parametros27 + argumentos6 + parametros48 + argumentos5 + parametros47);
                {
        ...
        private string ConstruirParametros21()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -fast -warp 32M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -nomonsters -warp 32M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -respawn -warp 32M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -warp 32M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -warp 32M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "chocolate-doom -merge master-wads/TEETH.WAD -warp 32M -connect ";
            }
        ...
        private string ConstruirParametros22()
        {
            ...
            {
                parametros2 += "chocolate-doom -autojoin ";
            }
            if (checkBox22.Checked)
            {
                parametros2 += "chocolate-doom -privateserver ";
            }
            if (checkBox23.Checked)
            {
                parametros2 += "chocolate-doom -connect ";
            }
        ...
        private void button23_Click(object sender, EventArgs e)
        {
            if (checkBox47.Checked)
            {
                ...
                {
                    MessageBox.Show("Please select at least one file from the list.");
                    return;
                }
                ...
                string seccionMerge = !string.IsNullOrEmpty(argumentosWad) ? $"-merge{argumentosWad}" : "";
                string seccionDeh = !string.IsNullOrEmpty(argumentosDeh) ? $"-deh{argumentosDeh}" : "";


                string serverName = textBox11.Text;
                string argumentos2 = $" {serverName}";
                string ipServidor = textBox12.Text;
                string argumentos = $" {ipServidor}";
                string ipServidor6 = textBox26.Text;
                string argumentos11 = $" {ipServidor6}";

                string parametros2 = ConstruirParametros22();
                string parametros4 = ConstruirParametros25();
                string parametros28 = ConstruirParametros28();
                string parametros30 = ConstruirParametros30();
                ...
                string argument2 = $"{param2} {param3} {param5} {param6} {param7} {param8} {param9} {param10}";
                string argumentosConfig = $"{argument2} {parametros2} {argumentos11} {parametros28} {argumentos11} {parametros30} {argumentos} {parametros4}";


                string argumentosFinales = $"{seccionMerge} {seccionDeh} {argumentosConfig}".Trim();


                try
                {
                    ProcessStartInfo info = new ProcessStartInfo();
                    info.FileName = "chocolate-doom.exe";
                    info.Arguments = argumentosFinales;
            ...
            else
            {
                ...
                ProcessStartInfo psi = new ProcessStartInfo
                {
                    ...
                    Arguments = Argument2 + parametros2 + argumentos11 + parametros28 + argumentos11 + parametros30 + argumentos + parametros4,
                ...
                {
                    MessageBox.Show("Error starting chocolate doom: The system cannot find the specified file.");
                }
            }
        }


        private string ConstruirParametros30()
        {
            string serverName = textBox11.Text;
            string parametros30 = "";
            ...
            {
                parametros30 = $" -servername {serverName}";
            }



            return parametros30.Trim();

        }

        private string ConstruirParametros25()
        {
            string puertoServidor = textBox19.Text;
            string parametros4 = "";

            if (checkBox38.Checked)
            {
                parametros4 = $" -port {puertoServidor}";
            }



            return parametros4.Trim();

        }

        private string ConstruirParametros27()
        {
            string demoName = textBox27.Text;
            string parametros27 = "";
            ...
            {
                parametros27 = $" -record {demoName}";
            }
            if (checkBox11.Checked)
            {
                parametros27 = $" -playdemo {demoName}";
            }


            return parametros27.Trim();

        }

        private string ConstruirParametros28()
        {
            string demoName = textBox28.Text;
            string parametros28 = "";

            if (checkBox12.Checked)
            {
                parametros28 = $" -record {demoName}";
            }
            if (checkBox13.Checked)
            {
                parametros28 = $" -playdemo {demoName}";
            }


            return parametros28.Trim();
        ...
        private void button24_Click(object sender, EventArgs e)
        {
            ...
            string serverName1 = textBox14.Text;
            string argumentos3 = $" {serverName1}";
            string ipServidor1 = textBox17.Text;
            string argumentos1 = $" {ipServidor1}";
            string ipServidor6 = textBox26.Text;
            string argumentos6 = $" {ipServidor6}";

            string parametros5 = ConstruirParametros26();
            string parametros3 = ConstruirParametros24();
            string parametros29 = ConstruirParametros29();
            string parametros31 = ConstruirParametros31();
            ...
            string Argument3 = $"{param10} {param11} {param12} {param13} {param14} {param15} {param16}";
            ...
            {
                FileName = "chocolate-doom.exe",
                Arguments = Argument3 + parametros3 + argumentos6 + parametros29 + argumentos6 + parametros31 + argumentos1 + parametros5,
                UseShellExecute = false,
                RedirectStandardOutput = true,
                CreateNoWindow = true
            ...
            {
                MessageBox.Show("Error executing the process: " + ex.Message);
            }
        }


        private string ConstruirParametros29()
        {
            string demoName = textBox18.Text;
            string parametros29 = "";

            if (checkBox48.Checked)
            {
                parametros29 = $" -record {demoName}";
            }
            if (checkBox49.Checked)
            {
                parametros29 = $" -playdemo {demoName}";
            }


            return parametros29.Trim();

        }

        private string ConstruirParametros31()
        {
            string serverName = textBox14.Text;
            string parametros31 = "";

            if (checkBox25.Checked)
            {
                parametros31 = $" -servername {serverName}";
            }



            return parametros31.Trim();
        ...
        private string ConstruirParametros24()
        {
            string parametros3 = "";
            ...
            {
                parametros3 += "chocolate-doom -respawn ";
            }
            if (checkBox34.Checked)
            {
                parametros3 += "chocolate-doom -fast ";
            }
            if (checkBox36.Checked)
            {
                parametros3 += "chocolate-doom -nomonsters ";
            }

            if (checkBox26.Checked)
            {
                parametros3 += "chocolate-doom -autojoin ";
            }
            if (checkBox27.Checked)
            {
                parametros3 += "chocolate-doom -privateserver ";
            }
            if (checkBox28.Checked)
            {
                parametros3 += "chocolate-doom -connect ";
            }



            return parametros3.Trim();

        }


        private string ConstruirParametros26()
        {
            string puertoServidor2 = textBox20.Text;
            string parametros5 = "";


            if (checkBox39.Checked)
            {
                parametros5 = $" -port {puertoServidor2}";
            }



            return parametros5.Trim();
        ...
        private string ConstruirParametros47()
        {
            string puertoServidor4 = textBox24.Text;
            string parametros47 = "";

            if (checkBox42.Checked)
            {
                parametros47 = $" -port {puertoServidor4}";
            }


            return parametros47.Trim();
        ...
        private string ConstruirParametros48()
        {
            string serverName4 = textBox23.Text;
            string parametros48 = "";

            if (checkBox41.Checked)
            {
                parametros48 = $" -servername {serverName4}";
            }


            return parametros48.Trim();
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 1:
                    { // <-- Llave de aislamiento obligatoria para C#
                ...
                case 0:
                        ...
                        List<Item> listaDoom1 = new List<Item>
                    {
                        ...
                        new Item("-warp 2 1", "E2M1: Deimos Lab"),
                        new Item("-warp 2 2", "E2M2: Containment Area"),
                        new Item("-warp 2 3", "E2M3: Refinery"),
                        new Item("-warp 2 4", "E2M4: Deimos Anomaly"),
                        ...
                        new Item("-warp 3 7", "E3M7: Gate to Limbo"),
                        new Item("-warp 3 8", "E3M8: Dis"),
                        new Item("-warp 3 9", "E3M9: Warrens (Secret)"),
                        ...
                        new Item("-warp 4 6", "E4M6: Against Thee Quite Fully"),
                        ...
                        comboBox6.DataSource = null;
                        comboBox6.DataSource = listaDoom1;
                        comboBox6.DisplayMember = "value";
                ...
                case 3:
                        ...
                        List<Item> listaplutonia = new List<Item>
                    {
                        ...
                        new Item("-warp 19", "MAP19: Nerves of Steel"),
        ...
        {
            if (checkBox17.Checked && comboBox6.SelectedIndex != -1)
            {

                comboBox6.SelectedIndex = -1;
            }
            if (checkBox21.Checked && comboBox6.SelectedIndex != -1)
            {

                comboBox6.SelectedIndex = -1;
            }

            if (checkBox23.Checked && comboBox6.SelectedIndex != -1)
            {

                comboBox6.SelectedIndex = -1;
            }
            if (checkBox13.Checked && comboBox6.SelectedIndex != -1)
            {
        ...
        private async void button30_Click(object sender, EventArgs e)
        {
            ...
            string rutaChocolateDoom = "chocolate-doom.exe";

            if (!File.Exists(rutaChocolateDoom))
            {
                richTextBox1.AppendText("Error: chocolate-doom.exe was not found in the directory.\n");
                return;
            }
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                if (File.Exists(tempWadPath2))
                {
                    File.Delete(tempWadPath2);
                }
                if (File.Exists(tempWadPath3))
                {
                    File.Delete(tempWadPath3);
                }
                if (File.Exists(tempWadPath4))
                {
                    File.Delete(tempWadPath4);
                }
                if (File.Exists(tempWadPath5))
                {
                    File.Delete(tempWadPath5);
                }
                if (File.Exists(tempWadPath6))
                {
                    File.Delete(tempWadPath6);
                }
                if (File.Exists(tempWadPath7))
                {
                    File.Delete(tempWadPath7);
                }
                if (File.Exists(tempWadPath8))
                {
                    File.Delete(tempWadPath8);
                }
                if (File.Exists(tempWadPath9))
                {
                    File.Delete(tempWadPath9);
                }
                if (File.Exists(tempWadPath10))
                {
                    File.Delete(tempWadPath10);
                }
                if (File.Exists(tempWadPath11))
                {
                    File.Delete(tempWadPath11);
                }
                if (File.Exists(tempWadPath12))
                {
                    File.Delete(tempWadPath12);
                }
                if (File.Exists(tempWadPath13))
                {
                    File.Delete(tempWadPath13);
                }
                if (File.Exists(tempWadPath14))
                {
                    File.Delete(tempWadPath14);
                }
                if (File.Exists(tempWadPath15))
                {
                    File.Delete(tempWadPath15);
                }
                if (File.Exists(tempWadPath16))
                {
                    File.Delete(tempWadPath16);
                }
                if (File.Exists(tempWadPath17))
                {
                    File.Delete(tempWadPath17);
                }
                if (File.Exists(tempWadPath18))
                {
                    File.Delete(tempWadPath18);
                }
                if (File.Exists(tempWadPath19))
                {
                    File.Delete(tempWadPath19);
                }
                if (File.Exists(tempWadPath20))
                {
                    File.Delete(tempWadPath20);
                }
                if (File.Exists(tempWadPath21))
                {
                    File.Delete(tempWadPath21);
                }
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Warning: The temporary file could not be deleted because it is still in use.");
